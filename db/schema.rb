...
ActiveRecord::Schema.define(version: 2023_04_20_094232) do
  ...
  create_table "shipping_addresses", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_transaction_id"], name: "index_shipping_addresses_on_item_transaction_id"
  end
  ...
  add_foreign_key "shipping_addresses", "item_transactions"
end
